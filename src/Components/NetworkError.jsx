...
export function NetworkError({ message }) {
    return (
        ...
        justify-center p-6  bg-gray-50 rounded-lg max-w-lg mx-auto mt-20">
            ...
            <h2 className="text-2xl font-semibold text-red-700">Network error</h2>
            <p className="text-gray-600 text-center mb-4">{'Unable to fetch data. Please check your network connection'}</p>
